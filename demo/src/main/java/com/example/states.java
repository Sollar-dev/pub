...
public class states {
    ...
    public states(boolean weak, short day, String num, String secName, String aud, String prof, String type, String title, String extra, String subGroup){
        this.weak = weak;
        this.day = day;
        this.num = num;
